...
/***/ "./src/js/libs/locomotive-scroll.min.js":
/*!**********************************************!*\
  !*** ./src/js/libs/locomotive-scroll.min.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
!function (t, e) {
  ...
  function e(e, i) {
    ...
    if (Array.isArray(e) || (s = function (e, i) {
      if (e) {
        ...
        return "Object" === s && e.constructor && (s = e.constructor.name), "Map" === s || "Set" === s ? Array.from(e) : "Arguments" === s || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s) ? t(e, i) : void 0;
      }
    ...
    constructor(t, _ref2) {
      ...
      this.lastDelta = {
        ...
        const {
          ...
          l = -(r - (null !== (i = null === (e = this.touchStart) || void 0 === e ? void 0 : e.x) && void 0 !== i ? i : 0)) * this.touchMultiplier,
          a = -(o - (null !== (n = null === (s = this.touchStart) || void 0 === s ? void 0 : s.y) && void 0 !== n ? n : 0)) * this.touchMultiplier;
        this.touchStart.x = r, this.touchStart.y = o, this.lastDelta = {
          x: l,
          y: a
        }, this.emitter.emit("scroll", {
          deltaX: l,
        ...
        e *= 1 === s ? l : 2 === s ? this.windowWidth : 1, i *= 1 === s ? l : 2 === s ? this.windowHeight : 1, e *= this.wheelMultiplier, i *= this.wheelMultiplier, this.emitter.emit("scroll", {
          deltaX: e,
          deltaY: i,
          event: t
        });
  ...
  class h {
    constructor() {
      ...
      this.__isScrolling = !1, this.__isStopped = !1, this.__isLocked = !1, this.userData = {}, this.lastVelocity = 0, this.velocity = 0, this.direction = 0, this.onPointerDown = t => {
        ...
        if (this.isTouching = "touchstart" === s.type || "touchmove" === s.type, this.options.syncTouch && n && "touchstart" === s.type && !this.isStopped && !this.isLocked) return void this.reset();
        if (0 === e && 0 === i || "vertical" === this.options.gestureOrientation && 0 === i || "horizontal" === this.options.gestureOrientation && 0 === e) return;
        let o = s.composedPath();
        o = o.slice(0, o.indexOf(this.rootElement));
        const l = this.options.prevent;
        if (o.find(t => {
          var e, i, s, o, a;
          return t instanceof Element && ("function" == typeof l && (null == l ? void 0 : l(t)) || (null === (e = t.hasAttribute) || void 0 === e ? void 0 : e.call(t, "data-lenis-prevent")) || n && (null === (i = t.hasAttribute) || void 0 === i ? void 0 : i.call(t, "data-lenis-prevent-touch")) || r && (null === (s = t.hasAttribute) || void 0 === s ? void 0 : s.call(t, "data-lenis-prevent-wheel")) || (null === (o = t.classList) || void 0 === o ? void 0 : o.contains("lenis")) && !(null === (a = t.classList) || void 0 === a ? void 0 : a.contains("lenis-stopped")));
        })) return;
        if (this.isStopped || this.isLocked) return void s.preventDefault();
        if (!(this.options.syncTouch && n || this.options.smoothWheel && r)) return this.isScrolling = "native", void this.animate.stop();
        s.preventDefault();
        let a = i;
        "both" === this.options.gestureOrientation ? a = Math.abs(i) > Math.abs(e) ? i : e : "horizontal" === this.options.gestureOrientation && (a = e);
        const h = n && this.options.syncTouch,
          c = n && "touchend" === s.type && Math.abs(a) > 5;
        c && (a = this.velocity * this.options.touchInertiaMultiplier), this.scrollTo(this.targetScroll + a, Object.assign({
          programmatic: !1
        }, h ? {
    ...
    scrollTo(t) {
      ...
      if (!this.isStopped && !this.isLocked || c) {
        ...
        if ("number" == typeof t && (t += e, t = Math.round(t), this.options.infinite ? u && (this.targetScroll = this.animatedScroll = this.scroll) : t = s(0, t, this.limit), t !== this.targetScroll)) {
          ...
          u || (this.targetScroll = t), this.animate.fromTo(this.animatedScroll, t, {
            ...
            onUpdate: (t, e) => {
              this.isScrolling = "smooth", this.lastVelocity = this.velocity, this.velocity = t - this.animatedScroll, this.direction = Math.sign(this.velocity), this.animatedScroll = t, this.setScroll(this.scroll), u && (this.targetScroll = t), e || this.emit(), e && (this.reset(), this.emit(), null == h || h(this), this.userData = {}, this.preventNextNativeScrollEvent());
            }
          });
        }
      }
  ...
  var c = /*#__PURE__*/function () {
    ...
    return i._init = function () {
      ...
      for (var i, s = e(this.scrollElements); !(i = s()).done;) this.observe(i.value.$el);
    }, i.destroy = function () {
  ...
  var v = /*#__PURE__*/function () {
      ...
      }, i._computeIntersection = function () {
      ...
      }, i._computeProgress = function (t) {
        var i,
          s = null != t ? t : (i = u(this.intersection.start, this.intersection.end, 0, 1, this.currentScroll)) < 0 ? 0 : i > 1 ? 1 : i;
        if (this.progress = s, s != this.lastProgress) {
          if (this.lastProgress = s, this.attributes.scrollCssProgress && this._setCssProgress(s), this.attributes.scrollEventProgress && this._setCustomEventProgress(s), this.attributes.scrollModuleProgress) for (var n, r = e(this.progressModularModules); !(n = r()).done;) {
            var o = n.value;
      ...
      }, i._setCssProgress = function (t) {
        void 0 === t && (t = 0), this.$el.style.setProperty("--progress", t.toString());
      }, i._setCustomEventProgress = function (t) {
        void 0 === t && (t = 0);
      ...
      }, i._getProgressModularModules = function () {
        if (this.modularInstance) {
          var t = Object.keys(this.$el.dataset).filter(function (t) {
              return t.includes("module");
            }),
            i = Object.entries(this.modularInstance.modules);
          if (t.length) for (var s, n = e(t); !(s = n()).done;) {
            var r = this.$el.dataset[s.value];
            if (!r) return;
            for (var o, l = e(i); !(o = l()).done;) {
              var a = o.value;
    ...
    p = /*#__PURE__*/function () {
      ...
      return i._init = function () {
        ...
        for (var i, s = t.currentScroll, n = e(this.RAFScrollElements); !(i = n()).done;) i.value.onResize({
          currentScroll: s
        });
      }, i.onRender = function (t) {
        for (var i, s = t.currentScroll, n = t.smooth, r = e(this.scrollElementsToUpdate); !(i = r()).done;) i.value.onRender({
          currentScroll: s,
          smooth: n
        });
    ...
    f = /*#__PURE__*/function () {
      ...
      return i._init = function () {
        ...
        for (var i, s = e(this.$resizeElements); !(i = s()).done;) this.observer.observe(i.value);
      }, i.destroy = function () {
        this.observer.disconnect();
      }, t;
    }(); /*#__PURE__*/
  return function () {
    function t(t) {
      var e = void 0 === t ? {} : t,
        ...
        v = e.initCustomTicker,
        m = e.destroyCustomTicker;
      ...
      for (var p = 0, f = Object.entries(s); p < f.length; p++) {
        var g = f[p][0];
        ["wrapper", "content", "infinite"].includes(g) && console.warn('Warning: Key "' + g + '" is not possible to edit in Locomotive Scroll.');
      }
      Object.assign(this, {
        lenisOptions: s,
        modularInstance: n,
    ...
    return e._init = function () {
      var t,
        e = this;
      this.lenisInstance = new h(i({}, this.lenisOptions, {
        wrapper: window,
      ...
      if (i) {
        var s = i.getAttribute("data-scroll-to-href") || i.getAttribute("href"),
          ...
          r = i.getAttribute("data-scroll-to-duration") || this.lenisInstance.options.duration;
        s && this.scrollTo(s, {
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _libs_locomotive_scroll_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./libs/locomotive-scroll.min.js */ "./src/js/libs/locomotive-scroll.min.js");
...
/* harmony import */ var _functions_disable_scroll_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/disable-scroll.js */ "./src/js/functions/disable-scroll.js");
/* harmony import */ var _functions_enable_scroll_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/enable-scroll.js */ "./src/js/functions/enable-scroll.js");
/* harmony import */ var _functions_header_height_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/header-height.js */ "./src/js/functions/header-height.js");
...
swiper__WEBPACK_IMPORTED_MODULE_6__["default"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_7__.Navigation]);
const customSlider = new swiper__WEBPACK_IMPORTED_MODULE_6__["default"]('.custom-slider', {
  slidesPerView: 1.57,
  spaceBetween: 40,
  loop: true,
  navigation: {
...
(0,_functions_header_height_js__WEBPACK_IMPORTED_MODULE_5__.getHeaderHeight)();
(function () {
  ...
  burger?.addEventListener('click', e => {
    ...
    if (menu?.classList.contains('menu--active')) {
      ...
      (0,_functions_disable_scroll_js__WEBPACK_IMPORTED_MODULE_3__.disableScroll)();
    } else {
      burger?.setAttribute('aria-expanded', 'false');
      burger?.setAttribute('aria-label', 'Открыть меню');
      (0,_functions_enable_scroll_js__WEBPACK_IMPORTED_MODULE_4__.enableScroll)();
    }
  });
